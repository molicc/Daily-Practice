 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://webservice/", wsdlLocation = "http://localhost:8888/WebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://webservice/", "WebServiceImplService");
    ...
    public webservice_wsdl.WebServiceImpl getWebServiceImplPort() {
        return super.getPort(new QName("http://webservice/", "WebServiceImplPort"), webservice_wsdl.WebServiceImpl.class);
    }
     ...
     */
    @WebEndpoint(name = "WebServiceImplPort")
    public webservice_wsdl.WebServiceImpl getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice/", "WebServiceImplPort"), webservice_wsdl.WebServiceImpl.class, features);
    }
